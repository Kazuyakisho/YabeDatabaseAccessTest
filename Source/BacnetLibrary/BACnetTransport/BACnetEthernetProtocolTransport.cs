...
{
    public class BacnetEthernetProtocolTransport : IBacnetTransport
    {
        ...
        public BacnetMaxApdu MaxAdpuLength { get { return BacnetMaxApdu.MAX_APDU1476; } }
        ...
        private LibPcapLiveDevice Open()
        {
            ...
            if (!string.IsNullOrEmpty(deviceName)) // specified interface
            {
                try
                {
                    var device = devices.FirstOrDefault(dev => dev.Interface.FriendlyName == deviceName);
