...
namespace BacnetLibrary.BACnetTransport
{
    public class BacnetPtpProtocolTransport : IBacnetTransport
    {
        ...
        public BacnetMaxApdu MaxAdpuLength { get { return PTP.PTP_MAX_APDU; } }
                        ...
                        case BacnetMstpProtocolTransport.GetMessageStatus.Good:
                            ...
                            switch (frame_type)
                            {
                                ...
                                case BacnetPtpFrameTypes.FRAME_TYPE_CONNECT_REQUEST:
                                    ...
                                    {
                                        byte[] pass = Encoding.ASCII.GetBytes(m_password);
                                ...
                                case BacnetPtpFrameTypes.FRAME_TYPE_CONNECT_RESPONSE:
                                    ...
                                    {
                                        string password = Encoding.ASCII.GetString(buffer, PTP.PTP_HEADER_LENGTH, msg_length);
