...
{
    public sealed class BacnetIpUdpProtocolTransport : IBacnetTransport, IDisposable
    {
        ...
        public BacnetMaxApdu MaxAdpuLength { get { return BVLC.BVLC_MAX_APDU; } }
            ...
            try
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            long ip = ((long)local_buffer[7] << 24) + ((long)local_buffer[6] << 16) + ((long)local_buffer[5] << 8) + local_buffer[4];
        ...
        //
        private BacnetAddress _GetBroadcastAddress()
        {
            // general broadcast
        ...
        // Give 0.0.0.0:xxxx if the socket is open with System.IPAddress.Any
