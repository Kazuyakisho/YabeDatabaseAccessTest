...
namespace BacnetLibrary.BACnetBase.BACnetSerialize
{
    public class BVLC
    {
        ...
        public const BacnetMaxApdu BVLC_MAX_APDU = BacnetMaxApdu.MAX_APDU1476;
        ...
        private void RegisterForeignDevice(IPEndPoint sender, int TTL)
        {
            lock (ForeignDevices)
            {
                ...
                System.Diagnostics.Trace.TraceInformation("Rejected FDR registration, IP : " + sender.Address);
            }
        }
        ...
        public int Encode(byte[] buffer, int offset, BacnetBvlcFunctions function, int msg_length)
        {
            ...
            if (BBMD_FD_ServiceActivated && (function == BacnetBvlcFunctions.BVLC_ORIGINAL_BROADCAST_NPDU))
            {
