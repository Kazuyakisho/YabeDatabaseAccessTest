...
namespace BACnetGenericDatabaseAccess
{
    ...
    public class DBManagerTest
    {
        ...
        private static readonly Lazy<DBManagerTest> _instance = new Lazy<DBManagerTest>(() => new DBManagerTest());
        ...
        public static DBManagerTest Instance => _instance.Value;
        ...
        public void InitTest()
        {
            ...
            DbProviders = new Dictionary<string, DBProvider>();
        ...
        {
            Assert.IsNotNull(DbProviderConnection);
            Assert.IsInstanceOf<DBProviderConnectionConfigFile>(DbProviderConnection);
            DbProviders = DbProviderConnection.Load();
            Assert.IsNotNull(DbProviders);
            //no servers in list for testing
            Assert.IsTrue(DbProviders.Count == 0);
        ...
        public void SaveCurrentProvider(string databaseName)
        {
            CurrentProvider.ConStringDataBase = databaseName;
